...
public class AboutDialog extends JDialog {
	...
	private JLabel lblCreator = new JLabel("<html>By Klaue</html>");
	...
	private JLabel lblDescSource = new JLabel("<html>Description from http://users.telenet.be/d.rijmenants/en/visualcrypto.htm</html>");
	private JLabel lblWeb = new JLabel("<html>Homepage: http://klaue.110mb.com</html>");
