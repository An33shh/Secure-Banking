...
<div class="headder-top">
  ...
  <section class="stats-count py-lg-4 py-md-3 py-sm-3 py-3">
    <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
      <form action="Check_authen2" method="post">
        <center>
          
          <h2>AUTHENTICATION PROCESS</h2><br>
          Authorized Mail Id:<input type="text" name="mail"><br><br>
          OTP Verification:<input type="password" name="otp"><br><br>
