...
<body>
  ...
  <div class="header-outs inner_page-banner " id="home">
      ...
      <nav>
        ...
        <ul class="menu mt-2">
          <li class="active">
            <a href="TPA_Home.jsp">Home</a>
          </li>
          <li class="active">
            <a href="owner_request.jsp">Owner Request</a>
          </li>
          <li class="active">
            <a href="user_request.jsp">User Request</a>
          </li>
          <li>
  ...
  <section class="stats-count py-lg-4 py-md-3 py-sm-3 py-3">
    <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
        ...
        <form action="own_login" method="post" onsubmit="return validateAll();">
            <center>
          <h2> <font face="Algerian" color="#0C6E69">OWNER LOGIN</font></h2><br>
            &nbsp;&nbsp;&nbsp;<font face="Algerian" color="#0C6E69">EMAIL ID&nbsp;:&nbsp;<input type="text" name="mail"></font><br><br>
            <font face="Algerian" color="#0C6E69">PASSWORD&nbsp;:&nbsp;<input type="password" name="password"></font><br><br>
