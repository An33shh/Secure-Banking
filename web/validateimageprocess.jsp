...
<html lang="zxx">
    ...
    <head>
        ...
        <meta http-equiv="refresh" content=3;url=tran_key.jsp?session.getAttribute("mail");%>
    ...
    <body>
        ...
        <section class="stats-count py-lg-4 py-md-3 py-sm-3 py-3">
            <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
                <font face="Algerian" color="#0C6E69"><h1 style="text-align: center">Validating the Images...</h1></font>
                <font face="Algerian" color="#0C6E69"><h3 style="text-align: center">Please Wait</h3></font>
