  ...
  <section class="stats-count py-lg-4 py-md-3 py-sm-3 py-3">
    <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
        <form action="" method="post">
            <center>
        <h3><font face="Algerian" color="#0C6E69">FILE VERIFICATION</font></h3>
      <table border="1">
          <tr>
                <td>FILE ID</td>
                <td>FILE NAME</td>
    ...
    String query="Select * from encrypt";
   ...
   %>
         ...
         <tr> 
             ...
             <td><%=rs.getString("serch_key1")%></td>
             <td><%=rs.getString("subject")%></td>
             <td><%=rs.getString("sts")%></td>
             <td> <a href="verify.jsp?file=<%=rs.getString("file_id")%>">VERIFY</a></td>
      </tr> 
