...
<body>
 ...
 <div class="headder-top">
  ...
  <%
      ...
      String secrete=request.getParameter("secre");
      String mail=request.getParameter("mail");
  %>
  
  <section class="stats-count py-lg-4 py-md-3 py-sm-3 py-3">
    <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
      <form action="send_response" method="post">
          <center>
              <font face="Algerian" color="#0C6E69">FILE ID:<br><input type="text" name="id" value="<%=fileid%>" style="text-align: center"></font><br><br>
              <font face="Algerian" color="#0C6E69">FILENAME:<br><input type="text" name="filename" value="<%=serch%>"></font><br><br>
              <font face="Algerian" color="#0C6E69">SECRETE KEY:<br><input type="text" name="secrete_key" value="<%=secrete%>"></font><br><br>
