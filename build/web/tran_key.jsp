    ...
    <body>
        ...
        <section class="stats-count py-lg-4 py-md-3 py-sm-3 py-3">
            <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
                ...
                <font face="Algerian" color="#0C6E69">
                <h1 style="text-align: center">Your Transaction Key : <%=rannum%> </h1></font>
                  <div>
                      <a  href ="transaction.jsp?trankey=<%=rannum%>"><input style="text-align: center" type="button" value="Click to Transaction"></a></div>
                <%

                    String trankey = request.getParameter("trankey");
                    String mail = request.getParameter("mail");
                    try {
                        DatabaseConnection db1 = new DatabaseConnection();
                        System.out.println(session.getAttribute("mail"));
                        
                        int j = db1.Delete("delete from trasaction where id='" + session.getAttribute("mail")+"'");
                         String query ="insert into trasaction values ('" + rannum + "','" + session.getAttribute("mail") + "')";
