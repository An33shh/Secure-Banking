...
String connectionURL = "jdbc:mysql://localhost:3306/image_authentication";
...
psmnt = con.prepareStatement("SELECT file FROM upload");
psmnt.setString(3, uid);
System.out.println(uid);
// here integer number 'fff' is image id from the table
