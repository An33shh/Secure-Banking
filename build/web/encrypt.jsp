...
<div class="headder-top">
  ...
  <section class="stats-count py-lg-4 py-md-3 py-sm-3 py-3">
    <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
      <center>
          <form action="encrypt_file" method="post">
              <font face="Algerian" color="#0C6E69">FILE ID&nbsp;:<br>&nbsp;<input type="text" name="file_id"  value="<%=fil%>" readonly="" style="text-align: center;"></font><br><br>
              <font face="Algerian" color="#0C6E69">SECRETE KEY &nbsp;:<br>&nbsp;<input type="text" name="sub" value="<%=ee.Encryption2(rs.getString("obj"))%>" readonly="" style="text-align: center;"></font><br><br>
              <font face="Algerian" color="#0C6E69">FILE NAME &nbsp;:<br>&nbsp;<input type="text" name="file_name" value="<%=ee.Encryption2(rs.getString("search_key"))%>" readonly="" style="text-align: center;"></font><br><br>
              <font face="Algerian" color="#0C6E69">SUBJECT&nbsp;:<br>&nbsp;<input type="text" name="sub" value="<%=ee.Encryption2(rs.getString("subject"))%>" readonly="" style="text-align: center;"></font><br><br>

              <font face="Algerian" color="#0C6E69">ENCRYPT FILES:</font><br>
     <textarea  name="file" rows="10" cols="50" style="font-size: 16px" readonly="">
                                                 <%
                                                String sss=ee.Encryption2(rs.getString("file_con"));
