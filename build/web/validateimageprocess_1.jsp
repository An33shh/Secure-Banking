...
<html lang="zxx">
    ...
    <head>
        ...
        <meta http-equiv="refresh" content=3;url=check1.jsp>
    ...
    <body>
        ...
        <section class="stats-count py-lg-4 py-md-3 py-sm-3 py-3">
            <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
                <font face="Algerian" color="#0C6E69"><h1 style="text-align: center">You have upload invaild Image..</h1></font>
                <font face="Algerian" color="#0C6E69"><h3 style="text-align: center">Please Retry</h3></font>
